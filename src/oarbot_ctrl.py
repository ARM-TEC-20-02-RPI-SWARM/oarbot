...
class OarbotControl():
    def __init__(self):
        ...
        self.controller_f = RoboteqHandler(debug_mode=True, exit_on_interrupt=False)
        self.controller_b = RoboteqHandler(debug_mode=True, exit_on_interrupt=False) 
        ...
        while not succeeded:
            ...
            if (len(a) > 1):
                try:
                    ...
                    #print(message)
                    message=controller.read_value("?FS")
                    message2=controller.read_value("?FM 1")
                    message3=controller.read_value("?FM 2")
                    print("correct values here:")
                    print(message)
                    print(message2)
                    print(message3)
            #        return 1e3
            ...
            #    message2=controller.read_value("?FM 1")
            #    message3=controller.read_value("?FM 2")
            #    print("wrong case 1 values here:")
            #    print(message)
            #    print(message2)
            #    print(message3)
